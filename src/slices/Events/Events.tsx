      ...
      <Wrapper>
        {slice.upcomingTitle ? (
          <>
            ...
            />
            <Spacer h={slice.filterSearch ? '14' : '10'} />
          </>
        ) : (
          <></>
        )}
        {slice.filterSearch && (upcomingEvents || pastEvents) ? (
          <>
            ...
            >
              ...
              {/* Sort Section */}
              <Box display="flex" gap="1px" width="48" alignItems="center">
                ...
                <Select
                  ...
                  options={[
                    {
                      label: Sort.NEWEST_FIRST,
                      value: formatMessage({
                        id: 'sections.events.eventsFilter.sortBy.newest',
                      }),
                    },
                    {
                      label: Sort.OLDEST_FIRST,
                      value: formatMessage({
                        id: 'sections.events.eventsFilter.sortBy.oldest',
                      }),
                    },
                  ]}
                />

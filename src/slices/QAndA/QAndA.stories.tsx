...
WithScroll.args = {
  slice: {
    ...
    questionsAndAnswers: [
      ...
      { id: 2, key: 'Question 2', value: 'Answer 2' },
      { id: 3, key: 'Question 3', value: 'Answer 3' },
      { id: 4, key: 'Question 4', value: 'Answer 4' },
      { id: 5, key: 'Question 5', value: 'Answer 5' },
      { id: 6, key: 'Question 6', value: 'Answer 6' },
      { id: 7, key: 'Question 7', value: 'Answer 7' },
    ],
    otherQuestions: 'Other questions?',
    button: { id: 1, text: 'Button', url: 'https://tree.ly' },
  },
...
Gray.args = {
  slice: {
    ...
    questionsAndAnswers: [
      ...
      { id: 2, key: 'Question 2', value: 'Answer 2' },
      { id: 3, key: 'Question 3', value: 'Answer 3' },
      { id: 4, key: 'Question 3', value: 'Answer 3' },
      { id: 5, key: 'Question 3', value: 'Answer 3' },
      { id: 6, key: 'Question 3', value: 'Answer 3' },
    ],
    otherQuestions: 'Other questions?',
    button: { id: 1, text: 'Button', url: 'https://tree.ly' },
  },
